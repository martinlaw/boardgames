...
```{r}
games.data <- games.data[games.data$year > 1900 & games.data$year < 2019, ]
```
...
ggplot(data=games.data[[games.data$year > 1900 & games.data$users_rated > third.q, ], mapping = aes(x=year, y=bayes_average))+
  geom_point()+
